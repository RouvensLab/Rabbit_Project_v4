...
# Default setting
BAUDRATE                    = 115200          # STServo default baudrate : 1000000
...
groupSyncRead = GroupSyncRead(packetHandler, STS_PRESENT_POSITION_L, 8)
...
while 1:
    ...
    while 1:
        ...
        for sts_id in range(1, 9):
            ...
            sts_data_result, sts_error = groupSyncRead.isAvailable(sts_id, STS_PRESENT_POSITION_L, 8)
            if sts_data_result == True:
                ...
                print("[ID:%03d] PresCur:%d" % (sts_id, packetHandler.sts_tohost(sts_present_current, 15)))
