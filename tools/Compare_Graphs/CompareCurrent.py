...
total_current = np.convolve(total_current, np.ones(25)/25, mode="valid")
total_current2 = np.convolve(total_current2, np.ones(25)/25, mode="valid")

#calc derivatives
total_current = np.gradient(total_current)
total_current2 = np.gradient(total_current2)
...
plt.plot(times, together, label="difference", linestyle="--")
