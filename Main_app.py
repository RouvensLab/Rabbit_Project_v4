...
class ManualExpert:
    def __init__(self, sim_freq= 5):
        ...
        #Best reallive Expert
        #self.action_timetable = {0.0: [-0.9, 0.0, -0.3, 0.3, -0.3, 0.3, 0.7, 0.7], 0.1: [-0.9, 0.0, -0.16, 0.6, -0.16, 0.6, -0.4, -0.4], 0.2: [-0.9, 0.0, 0.2, 0.4, 0.2, 0.4, -0.4, -0.4], 0.35: [0.3, 0.0, -0.1, 0.0, -0.1, 0.0, 0.6, 0.6], 0.5: [-0.9, 0.0, -0.3, 0.5, -0.3, 0.5, 0.65, 0.65], 0.6: [-1.0, 0.0, -0.4, -0.6, -0.4, -0.6, 1.0, 1.0]}
